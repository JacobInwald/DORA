...
#ifndef DORA_SRVS__SRV__DETAIL__LDS_CMD__FUNCTIONS_H_
#define DORA_SRVS__SRV__DETAIL__LDS_CMD__FUNCTIONS_H_
...
/// Create srv/LdsCmd message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dora_srvs__srv__LdsCmd_Request__init().
...
/// Destroy srv/LdsCmd message.
/**
 * It calls
 * dora_srvs__srv__LdsCmd_Request__fini()
...
/// Check for srv/LdsCmd message equality.
/**
...
/// Initialize array of srv/LdsCmd messages.
/**
...
/// Finalize array of srv/LdsCmd messages.
/**
 * It calls
 * dora_srvs__srv__LdsCmd_Request__fini()
...
/// Create array of srv/LdsCmd messages.
/**
 * It allocates the memory for the array and calls
 * dora_srvs__srv__LdsCmd_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/LdsCmd messages.
/**
 * It calls
 * dora_srvs__srv__LdsCmd_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/LdsCmd message array equality.
/**
...
/// Copy an array of srv/LdsCmd messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dora_srvs__srv__LdsCmd_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dora_srvs
...
/**
 * It calls
 * dora_srvs__srv__LdsCmd_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_dora_srvs
...
/**
 * It allocates the memory for the array and calls
 * dora_srvs__srv__LdsCmd_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dora_srvs
...
/**
 * It calls
 * dora_srvs__srv__LdsCmd_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DORA_SRVS__SRV__DETAIL__LDS_CMD__FUNCTIONS_H_
