# From GitHub: https://github.com/tjmarkham/python-stepper
...
class Stepper:
    ...
    def __init__(self, pins):
        ...
        print(
            f"Stepper initialized (step={self.stepPin}, direction={self.directionPin}, enable={self.enablePin}")
    ...
    def step(self, steps, dir, speed=1, stayOn=False):
        ...
        print("stepperDriver complete (turned " +
              dir + " " + str(steps) + " steps)")
