...
#include "dora_msgs/msg/detail/toys__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  // Member: toys
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.toys[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: toys
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dora_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Toy(
  ...
  if (is_plain) {
    ...
    using DataType = dora_msgs::msg::Toys;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dora_msgs::msg::Toys *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dora_msgs::msg::Toys *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Toys__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const dora_msgs::msg::Toys *>(
...
static size_t _Toys__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Toys(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Toys__callbacks = {
  "dora_msgs::msg",
  "Toys",
...
static rosidl_message_type_support_t _Toys__handle = {
...
{
  return &dora_msgs::msg::typesupport_fastrtps_cpp::_Toys__handle;
}
