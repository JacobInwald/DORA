...
#include "dora_msgs/msg/detail/cloud__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dora_msgs::msg::Cloud & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dora_msgs::msg::Cloud & ros_message)
{
  // Member: position
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dora_msgs::msg::Cloud;
    is_plain =
      (
      offsetof(DataType, max_range) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const dora_msgs::msg::Cloud *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dora_msgs::msg::Cloud *>(
    untyped_ros_message);
...
{
  return &dora_msgs::msg::typesupport_fastrtps_cpp::_Cloud__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dora_msgs, msg, Cloud)() {
  return &dora_msgs::msg::typesupport_fastrtps_cpp::_Cloud__handle;
}
