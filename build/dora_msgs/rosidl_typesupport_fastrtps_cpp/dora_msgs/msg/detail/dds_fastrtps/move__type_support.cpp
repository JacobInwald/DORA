...
#include "dora_msgs/msg/detail/move__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dora_msgs::msg::Move & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dora_msgs::msg::Move & ros_message)
{
  // Member: type
  cdr >> ros_message.type;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dora_msgs::msg::Move;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dora_msgs::msg::Move *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dora_msgs::msg::Move *>(
    untyped_ros_message);
...
{
  return &dora_msgs::msg::typesupport_fastrtps_cpp::_Move__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dora_msgs, msg, Move)() {
  return &dora_msgs::msg::typesupport_fastrtps_cpp::_Move__handle;
}
