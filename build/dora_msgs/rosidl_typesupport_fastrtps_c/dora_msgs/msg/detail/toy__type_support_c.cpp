...
#include "dora_msgs/msg/detail/toy__rosidl_typesupport_fastrtps_c.h"
...
using _Toy__ros_msg_type = dora_msgs__msg__Toy;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Toy__ros_msg_type * ros_message = static_cast<const _Toy__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Toy__ros_msg_type * ros_message = static_cast<_Toy__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _Toy__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dora_msgs__msg__Toy(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dora_msgs__msg__Toy;
    is_plain =
      (
...
static size_t _Toy__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dora_msgs__msg__Toy(
...
static message_type_support_callbacks_t __callbacks_Toy = {
  "dora_msgs::msg",
  "Toy",
  _Toy__cdr_serialize,
...
static rosidl_message_type_support_t _Toy__type_support = {
