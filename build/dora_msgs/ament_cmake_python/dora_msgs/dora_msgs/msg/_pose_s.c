...
bool dora_msgs__msg__pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dora_msgs.msg._pose.Pose", full_classname_dest, 24) == 0);
  }
  dora_msgs__msg__Pose * ros_message = _ros_message;
  {  // x
  ...
  {  // rot
    ...
    assert(PyFloat_Check(field));
    ros_message->rot = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * dora_msgs__msg__pose__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dora_msgs.msg._pose");
  ...
  {  // rot
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->rot);
    {
