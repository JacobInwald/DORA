...
static const _WheelsCmd_Request_type_support_symbol_names_t _WheelsCmd_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dora_srvs, srv, WheelsCmd_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dora_srvs, srv, WheelsCmd_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dora_srvs, srv, WheelsCmd_Request)() {
  return &::dora_srvs::srv::rosidl_typesupport_c::WheelsCmd_Request_message_type_support_handle;
}
...
static const _WheelsCmd_Response_type_support_symbol_names_t _WheelsCmd_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dora_srvs, srv, WheelsCmd_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dora_srvs, srv, WheelsCmd_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dora_srvs, srv, WheelsCmd_Response)() {
  return &::dora_srvs::srv::rosidl_typesupport_c::WheelsCmd_Response_message_type_support_handle;
}
...
static const _WheelsCmd_type_support_symbol_names_t _WheelsCmd_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dora_srvs, srv, WheelsCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dora_srvs, srv, WheelsCmd)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, dora_srvs, srv, WheelsCmd)() {
  return &::dora_srvs::srv::rosidl_typesupport_c::WheelsCmd_service_type_support_handle;
}
