...
static const _LoopCmd_Request_type_support_symbol_names_t _LoopCmd_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dora_srvs, srv, LoopCmd_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dora_srvs, srv, LoopCmd_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dora_srvs, srv, LoopCmd_Request)() {
  return &::dora_srvs::srv::rosidl_typesupport_c::LoopCmd_Request_message_type_support_handle;
}
...
static const _LoopCmd_Response_type_support_symbol_names_t _LoopCmd_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dora_srvs, srv, LoopCmd_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dora_srvs, srv, LoopCmd_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dora_srvs, srv, LoopCmd_Response)() {
  return &::dora_srvs::srv::rosidl_typesupport_c::LoopCmd_Response_message_type_support_handle;
}
...
static const _LoopCmd_type_support_symbol_names_t _LoopCmd_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dora_srvs, srv, LoopCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dora_srvs, srv, LoopCmd)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, dora_srvs, srv, LoopCmd)() {
  return &::dora_srvs::srv::rosidl_typesupport_c::LoopCmd_service_type_support_handle;
}
