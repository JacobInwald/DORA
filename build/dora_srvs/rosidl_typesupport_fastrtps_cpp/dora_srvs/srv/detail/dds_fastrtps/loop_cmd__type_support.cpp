...
#include "dora_srvs/srv/detail/loop_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dora_srvs::srv::LoopCmd_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dora_srvs::srv::LoopCmd_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dora_srvs::srv::LoopCmd_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LoopCmd_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const dora_srvs::srv::LoopCmd_Request *>(
...
static size_t _LoopCmd_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_LoopCmd_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _LoopCmd_Request__callbacks = {
  "dora_srvs::srv",
  "LoopCmd_Request",
...
static rosidl_message_type_support_t _LoopCmd_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LoopCmd_Request__callbacks,
...
{
  return &dora_srvs::srv::typesupport_fastrtps_cpp::_LoopCmd_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = dora_srvs::srv::LoopCmd_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dora_srvs::srv::LoopCmd_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<dora_srvs::srv::LoopCmd_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LoopCmd_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const dora_srvs::srv::LoopCmd_Response *>(
...
static size_t _LoopCmd_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_LoopCmd_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _LoopCmd_Response__callbacks = {
  "dora_srvs::srv",
  "LoopCmd_Response",
...
static rosidl_message_type_support_t _LoopCmd_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LoopCmd_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &dora_srvs::srv::typesupport_fastrtps_cpp::_LoopCmd_Response__handle;
}
...
static service_type_support_callbacks_t _LoopCmd__callbacks = {
  "dora_srvs::srv",
  "LoopCmd",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dora_srvs, srv, LoopCmd_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dora_srvs, srv, LoopCmd_Response)(),
...
static rosidl_service_type_support_t _LoopCmd__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LoopCmd__callbacks,
...
{
  return &dora_srvs::srv::typesupport_fastrtps_cpp::_LoopCmd__handle;
}
