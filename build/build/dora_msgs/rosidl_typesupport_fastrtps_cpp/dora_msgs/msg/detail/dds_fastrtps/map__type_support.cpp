...
#include "dora_msgs/msg/detail/map__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dora_msgs::msg::Map & ros_message,
  ...
  size_t current_alignment)
{
  ...
  // Member: clouds
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dora_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Cloud(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = dora_msgs::msg::Map;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dora_msgs::msg::Map *>(
    untyped_ros_message);
...
{
  return &dora_msgs::msg::typesupport_fastrtps_cpp::_Map__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dora_msgs, msg, Map)() {
  return &dora_msgs::msg::typesupport_fastrtps_cpp::_Map__handle;
}
