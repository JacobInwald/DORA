...
bool dora_msgs__msg__map__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dora_msgs.msg._map.Map", full_classname_dest, 22) == 0);
  }
  dora_msgs__msg__Map * ros_message = _ros_message;
  {  // offset
    PyObject * field = PyObject_GetAttrString(_pymsg, "offset");
    if (!field) {
      return false;
    }
    if (!dora_msgs__msg__pose__convert_from_py(field, &ros_message->offset)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // clouds
    ...
    if (!dora_msgs__msg__Cloud__Sequence__init(&(ros_message->clouds), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create dora_msgs__msg__Cloud__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    dora_msgs__msg__Cloud * dest = ros_message->clouds.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!dora_msgs__msg__cloud__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * dora_msgs__msg__map__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dora_msgs.msg._map");
  ...
  {  // offset
    PyObject * field = NULL;
    field = dora_msgs__msg__pose__convert_to_py(&ros_message->offset);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // clouds
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = dora_msgs__msg__cloud__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
