...
#include "dora_msgs/msg/detail/cloud__rosidl_typesupport_fastrtps_c.h"
...
#include "dora_msgs/msg/detail/pose__functions.h"  // position
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_dora_msgs
...
using _Cloud__ros_msg_type = dora_msgs__msg__Cloud;
...
static uint32_t _Cloud__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dora_msgs__msg__Cloud(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dora_msgs__msg__Cloud;
    is_plain =
      (
...
static size_t _Cloud__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dora_msgs__msg__Cloud(
